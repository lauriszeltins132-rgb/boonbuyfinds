...
export const SPREADSHEET_ARCHITECTURE_PAGES: Record<string, SeoArchitecturePage> = {
  spreadsheet: page({
    ...
    relatedLinks: [
      { href: "/best-boonbuy-spreadsheet", label: "Best spreadsheet" },
  ...
  "best-spreadsheet": page({
    ...
    relatedLinks: [{ href: "/boonbuy-spreadsheet", label: "Spreadsheet hub" }],
    relatedArticleSlugs: SHEET_RELATED,
    spreadsheetHref: "/boonbuy-spreadsheet",
  }),
  ...
  "china-spreadsheet": page({
    ...
    relatedLinks: [{ href: "/boonbuy-spreadsheet", label: "Hub" }],
    relatedArticleSlugs: SHEET_RELATED,
    spreadsheetHref: "/boonbuy-spreadsheet",
  }),
  ...
  "best-boonbuy-spreadsheet": page({
    ...
    relatedLinks: [{ href: "/best-boonbuy-spreadsheet", label: "Best spreadsheet overall" }],
    relatedArticleSlugs: SHEET_RELATED,
    spreadsheetHref: "/boonbuy-spreadsheet",
