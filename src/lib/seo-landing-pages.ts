...
export const SEO_LANDING_PAGES: Record<string, SeoLandingConfig> = {
  ...
  "best-boonbuy-spreadsheet": {
    ...
    sections: [
      ...
      {
        heading: "How to shop the best spreadsheet finds",
        paragraphs: [
    ...
    faqs: [
      {
        ...
        answer:
          "Most buyers now prefer a searchable catalog like BoonBuy Finds over downloading a new Google Sheet every week. You get the same Weidian and Taobao product universe with better mobile search and shareable links.",
      },
      {
  ...
  "best-boonbuy-finds": {
    ...
    relatedLinks: [
      ...
      { href: "/trending-boonbuy-finds", label: "Trending finds" },
      { href: "/best-boonbuy-finds-under-50", label: "Under $50" },
      { href: "/boonbuy-coupons", label: "Coupons" },
  ...
  "best-boonbuy-finds-under-50": {
    ...
    relatedLinks: [
      { href: "/boonbuy", label: "What is BoonBuy?" },
      { href: "/best-boonbuy-finds", label: "Best finds" },
      { href: "/best-boonbuy-under-20", label: "Under $20" },
      { href: "/latest-finds", label: "Latest finds" },
      { href: "/boonbuy-coupons", label: "Coupons" },
    ],
