...
const PARAGRAPHS = [
  ...
  "Most finds on BoonBuy Finds come from Weidian and Taobao sellers. Weidian is popular for sneakers, streetwear, and independent brands; Taobao covers a wider mix of fashion and accessories. BoonBuy Finds does not host the shops — it indexes affiliate and community spreadsheet links and routes you through your chosen agent with the correct product URL encoded.",
  "BoonBuy is the recommended agent on this site because of shipping discounts, a polished app, and reliable QC workflows — but you are not locked in. OopBuy, Kakobuy, MuleBuy, and ACBuy are fully supported on every product page. Switch agents in the header before you click Buy; the link rebuilds automatically for the same listing.",
